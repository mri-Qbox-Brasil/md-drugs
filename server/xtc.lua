...
RegisterServerEvent('md-drugs:server:getpressback', function(type)
    ...
    if type == 'single' then
        if Player.Functions.GetItemByName('singlepress') then
            Notifys('You Already Have A Kit')
            return
        end
        AddItem('singlepress', 1)
    elseif type == 'dual' then
        if Player.Functions.GetItemByName('dualpress') then
            Notifys('You Already Have A Kit')
            return
        end
        AddItem('dualpress', 1)
    elseif type == 'triple' then
        if Player.Functions.GetItemByName('triplepress') then
            Notifys('You Already Have A Kit')
            return
        end
        AddItem('triplepress', 1)
    elseif type == 'quad' then
        if Player.Functions.GetItemByName('quadpress') then
            Notifys('You Already Have A Kit')
            return
        end
        AddItem('quadpress', 1)
